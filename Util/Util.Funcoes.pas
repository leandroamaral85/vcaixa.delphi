...
class function TFuncoesUtil.ValidaToken(pToken: String): Boolean;
var
   vJWT : TJWT;
   vErro: string;
begin
...
class function TFuncoesUtil.RetornaToken(pUsuario: TUsuario): string;
var
   vJWT : TJWT;
begin
...
class function TFuncoesUtil.RetornaDadosToken(pToken: String) : TDadosToken;
var
   vJWT : TJWT;
   vErro: string;
begin
